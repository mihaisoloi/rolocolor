 ...
 */
public class ColorBlindness extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        switch (ColorBlindness.viewMode) {
            ...
            case ColorBlindness.VIEW_MODE_HIST:
                Mat hist = new Mat();
            ...
            case ColorBlindness.VIEW_MODE_CANNY:
            ...
            case ColorBlindness.VIEW_MODE_SOBEL:
            ...
            case ColorBlindness.VIEW_MODE_SEPIA:
                rgbaInnerWindow = rgba.submat(top, top + height, left, left + width);
            ...
            case ColorBlindness.VIEW_MODE_POSTERIZE:
            /*
